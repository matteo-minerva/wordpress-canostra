...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210430_canostra_98a511042d5a5e862419_20210430151246_archive.zip';
	const ARCHIVE_SIZE		 = '39930612';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '98a5110-30151246';
    const SECONDARY_PACKAGE_HASH = '2006d76-30151246';
	const VERSION			 = '1.4.0';
